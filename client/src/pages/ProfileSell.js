  ...
  return (
    <div className="defaultContainer">
      ...
      <Container className="main-area">
        <Row>
          <Col lg={5}>
            <p className="text-right">디자인 이름</p>
          </Col>
          <Col lg={7}>
            {" "}
            <input
        ...
        <Row>
          <Col lg={5}>
            <p className="text-right">디자인 설명</p>
          </Col>
          <Col lg={7}>
            {" "}
            <input
        ...
        <Row>
          <Col lg={5}>
            <p className="text-right">디자인 카테고리</p>
          </Col>
          <Col lg={7}>
            <Dropdown>
              <Dropdown.Toggle
        ...
        <Row>
          <Col lg={5}>
            <p className="text-right">디자인 가격</p>
          </Col>
          <Col lg={7}>
            {" "}
            <input
        ...
        <Row>
          <Col lg={5}>
            <p className="text-right">디자인 첨부</p>
          </Col>
          <Col lg={3}>
            <p>파일이름.jpg</p>
          </Col>
          <Col lg={4}>
            {" "}
            <Button variant="warning">파일 선택</Button>{" "}
          </Col>
        </Row>
