    ...
    <div className="buy">
      <div className="main">
        ...
        <div className="buy_cancle">
          <button className="buy_btn" onClick={openModal}>
            구매
          </button>
          <Link to="/CardDetail" className="cancle_btn">
            취소
          </Link>
        </div>
        ...
        {isModalOpen && (
          <div className="modal2">
            ...
            <div className="modal_buy_cancle">
              <Link to="/CardDetailMy" className="cancle_btn">
                <button className="modal_buy">구매</button>
              </Link>
              <button className="modal_cancle" onClick={closeModal}>
                취소
              </button>
            </div>
          </div>
